...
namespace SecureChatClient
{
    public partial class Form1 : Form
    {
        ...
        public void ReceiveMessage()
        {
            try
            {
                ...
                while ((strServerMsg = srClientReader.ReadLine()) != string.Empty)
                {
                    ...
                    {
                        //if ((strServerMsg.Length > 4 && strServerMsg.Substring(0, 4) != "KEY:" && strServerMsg.Substring(0, 4) != "Mode" && strServerMsg.Substring(0, 4) != "MOD:" && strServerMsg != "Disconnected") || (strServerMsg.Length <= 4))
                        //{
                        //    DialogResult dialogResult = MessageBox.Show("Do you want to decrypt the message", "Decryption", MessageBoxButtons.YesNo);
                        //    if (dialogResult == DialogResult.Yes)
                        //    {
                        //        string[] words = strServerMsg.Split(' ');
                        ...
                        //            i++;
                        //        }
                        //        strServerMsg = new string(objPublicKey.Decrypt(lClientMsg));
                        //        //break;
                        //    }
                        //}
                    }
                    else if (strScheme == "Mode-4")
                    {
                        ...
                        if (dialogResult == DialogResult.Yes)
                        {
                            ...
                            strServerMsg = objAESImplement.Decrypt(strServerMsg, strKey);
                            //break;
                        }
                    }
        ...
        public void UpdateLog(string strMessage)
        {
            try
            {
                ...
                Func<int> delUpdate = delegate ()
                {
                    ...
                    {
                        //objPublicKey.EncrypeClient = Int64.Parse(strMessage.Substring(4));
        ...
        private void btnMode_Click(object sender, EventArgs e)
        {
            try
            {
                if (cmbMode.SelectedValue != null && cmbMode.SelectedValue.ToString() != "-0-")
                {
                    ...
                    else if (cmbMode.SelectedValue.ToString() == "Mode-4")
                    {
                        txtFactor1.Text = string.Empty;
                        txtFactor2.Text = string.Empty;
                        txtEncryptKey.Text = string.Empty;
        ...
        private void btnGenerateKey_Click(object sender, EventArgs e)
        {
            ...
            //    swClientSender.WriteLine("KEY:" + objPublicKey.e[0].ToString());
            //    swClientSender.Flush();
